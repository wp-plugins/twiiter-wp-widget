...
Using the Twitter WP Widget you can display feeds on your blog of your latest tweets, keeping your visitors interested in what you have to offer.

This sidebar widget allows you to set options on how many tweets to display, the time period to refresh your tweets and check for new ones (cache) and even choose from several different skins or themes. This is a simple to setup widget, which you can have up and running in minutes. 
...
1. Go to the admin menu 'Plugins' -> 'Install' and search for 'twitter-wp-widget.zip'
...
1. Unzip the folder `twitter-wp-widget.zip` and move files to the `/wp-content/plugins/` directory.
...
1. screenshot1.png Twitter WP as seen to your users
2. screenshot2.png Twitter WP as it looks from the administation section
...
Twitter WP widget is released under the GNU General Public License V3.For more information please read<a href="http://www.gnu.org/copyleft/gpl.html">http://www.gnu.org/copyleft/gpl.html</a>
